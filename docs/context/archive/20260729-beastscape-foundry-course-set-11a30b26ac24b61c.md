...
> Compact projection, not project canon. Generated `2026-07-29T18:04:40+00:00` from cited
> repository sources. Input digest: `11a30b26ac24b61c`.
...
Build the first Beastscape Foundry: compare multiple explicit developmental grammars through independently generated atlases and learned continuous Passages.
...
Implement and verify the first comparative Foundry slice, then human-test whether its candidate Beastscapes differ meaningfully in creature quality, structural diversity, and navigational character.
