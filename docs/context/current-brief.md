...
> Compact projection, not project canon. Generated `2026-08-01T19:46:09+00:00` from cited
> repository sources. Input digest: `7455260bc8689ae7`.
...
- cmds.sh -- new dated block added and executed recording the redeploy and the stale-credential-file cleanup.
- docs/deployment.md -- new dated amendment entry documenting the removal and its reasoning.
- tools/chat-captain/README.md, docs/README.md -- updated to match.
