...
// Deployed-copy divergence from source: two levels up from web/toys/periscope/
// already reaches web/, so no extra "web/" segment here (see docs/deployment.md).
const DUCK_MODEL_PATH = "../../assets/models/uss-rubber-ducky.glb";
