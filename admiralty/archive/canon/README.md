...
This directory is an index of candidate and established governing material. It
does not duplicate source documents. Each entry links to the original and
states its authority status.

## Current candidates

- [Monad Charter](../../../000_HIGHEST_PRIORITY_MONAD_CHARTER_2026-07-14.md) —
  highest-priority duty record; source status applies.
- [Command Charter](../../../001_MONAD_COMMAND_CHARTER_2026-07-15.md) —
  explicitly provisional; preserved as historical command formulation.
- [Project Mission](../../../docs/mission.md) — current documentation-level
  framing; not a replacement for human canon adoption.
- [Safety overview](../../../docs/safety/README.md) — synthesis of existing
